...
# Setup instructions
- Clone the repostitory: `git clone git@github.com:jase231/root_dependency_test.git && cd root_dependency_test`
- Create and source a virtual environment: `python3 -m venv venv && source venv/bin/activate`
- From the repository's root, install the package with `pip install .`
